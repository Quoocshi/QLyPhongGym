...
-- YOGA
INSERT ALL
    INTO LICHTAP (MaLT, LoaiLich, Thu, Ca, MaLop, MaKH, MaNV, MaKV, TrangThai)
    ...
    INTO LICHTAP (MaLT, LoaiLich, Thu, Ca, MaLop, MaKH, MaNV, MaKV, TrangThai)
        VALUES ('LT019', 'Lop', '246', 'CA01', 'LOP07', NULL, 'PT003', 'KV02', 'Dang mo')
    INTO LICHTAP (MaLT, LoaiLich, Thu, Ca, MaLop, MaKH, MaNV, MaKV, TrangThai)
        VALUES ('LT020', 'Lop', '357', 'CA06', 'LOP07', NULL, 'PT003', 'KV02', 'Dang mo')
    INTO LICHTAP (MaLT, LoaiLich, Thu, Ca, MaLop, MaKH, MaNV, MaKV, TrangThai)
        VALUES ('LT021', 'Lop', '135', 'CA02', 'LOP08', NULL, 'PT006', 'KV02', 'Dang mo')
    INTO LICHTAP (MaLT, LoaiLich, Thu, Ca, MaLop, MaKH, MaNV, MaKV, TrangThai)
        VALUES ('LT022', 'Lop', '24',  'CA05', 'LOP07', NULL, 'PT006', 'KV02', 'Dang mo')
    INTO LICHTAP (MaLT, LoaiLich, Thu, Ca, MaLop, MaKH, MaNV, MaKV, TrangThai)
        VALUES ('LT023', 'Lop', '246', 'CA03', 'LOP02', NULL, 'PT003', 'KV02', 'Dang mo')
    INTO LICHTAP (MaLT, LoaiLich, Thu, Ca, MaLop, MaKH, MaNV, MaKV, TrangThai)
        VALUES ('LT024', 'Lop', '135', 'CA04', 'LOP09', NULL, 'PT006', 'KV02', 'Dang mo')
SELECT 1 FROM DUAL;
