...
insert into "USER"(full_name, email, created_at, updated_at, is_deleted)
values ('staff1','staff1@gmail.com',current_timestamp,current_timestamp,0);
insert into ACCOUNT(user_id, username, password_hash, status, created_at, updated_at, is_deleted)
values (42,'staff1','$2a$12$PHzj0FdE5dnJez2yWuDcGuO8IkwDLukSapOovJc6uUqtRmnPtWktC','ACTIVE',current_timestamp,current_timestamp,0);
insert into ACCOUNT_ASSIGN_ROLE_GROUP(account_id, role_group_id, created_at, updated_at, is_deleted)
values (42,3,current_timestamp,current_timestamp,0);
