...
public interface LichTapService {
    ...
    // Create PT schedule with multiple days (e.g., "246CN")
    LichTap createPTScheduleMultipleDays(String maNV, String maKH, String ngayBatDau, String thuString, String caTap,
            String maKV);
     ...
     */
    /**
     * Tạo lịch lớp mới với ngày cụ thể
     * 
     * @param maNV    Mã trainer
     * @param maLop   Mã lớp
     * @param ngayTap Ngày tập cụ thể (yyyy-MM-dd)
